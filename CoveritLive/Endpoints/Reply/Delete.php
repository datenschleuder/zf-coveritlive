 ...
 * ZF-CoveritLive
 * 
 * This method allows you to delete any reply. Any deletion made will immediately propagate 
 * to all readers of the live event in real time. Reply items are identified by a reply id, 
 * which is returned by the reply/create and event/data API methods.
 *
 *
 *
 ...
 * @version    1.0
 * @see        http://www.coveritlive.com/index.php?option=com_content&task=view&id=408
 * @license    MIT
 */
final class ZendX_CoveritLive_Endpoints_Reply_Delete implements 
        ZendX_CoveritLive_Interfaces_Endpoint
{
     ...
     * @return ZendX_CoveritLive_Endpoints_Reply_Delete
     */
