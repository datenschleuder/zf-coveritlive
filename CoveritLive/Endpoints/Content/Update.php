 ...
 * ZF-CoveritLive
 * 
 * This method allows you to update any item in a live event. Similar to the Live Edit functionality 
 * available through the console, any update made will immediately propagate to all readers of 
 ...
 * @version    1.0
 * @see        http://www.coveritlive.com/index.php?option=com_content&task=view&id=337
 * @license    MIT
 */
final class ZendX_CoveritLive_Endpoints_Content_Update implements 
        ZendX_CoveritLive_Interfaces_Endpoint
{
     ...
     * 
     * @param string $code
     * @return ZendX_CoveritLive_Endpoints_Content_Update
     */
    ...
    /**
     * The id of the event item to be updated.
     * 
