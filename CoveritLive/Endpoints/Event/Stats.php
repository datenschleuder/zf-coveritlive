 ...
 * ZF-CoveritLive
 * 
 * This method allows users to retrieve statistics for a CoveritLive event. 
 * Statistics can only be retrieved for events that are in a completed (aka finished) state. 
 * Available stats include total page views, total clicks, average duration, and 
 * detailed click and page view numbers by day.
 *
 *
 *
 ...
 * @version    1.0
 * @see        http://www.coveritlive.com/index.php?option=com_content&task=view&id=311
 * @license    MIT
 */
final class ZendX_CoveritLive_Endpoints_Event_Stats implements 
        ZendX_CoveritLive_Interfaces_Endpoint
{
     ...
     * 
     * @param string $code
     * @return ZendX_CoveritLive_Endpoints_Event_Stats
     */
