 ...
 * ZF-CoveritLive
 * 
 * This method allows users to end CoveritLive events automatically. 
 * When coupled with the event/create and event/start methods, the CiL event 
 ...
 * @version    1.0
 * @see        http://www.coveritlive.com/index.php?option=com_content&task=view&id=284
 * @license    MIT
 */
final class ZendX_CoveritLive_Endpoints_Event_End implements 
        ZendX_CoveritLive_Interfaces_Endpoint
{
     ...
     * 
     * @param string $code
     * @return ZendX_CoveritLive_Endpoints_Event_End
     */
